...
/**
 * Test suite for federations.
 */
public class FederationsManagementFunctionalTests extends
        AbstractADMTestSuite {

    private static final String federationId = "testFederationId";
    private static final String federationName = "testFederationName";
    private static final String dummyPlatformId = "dummyPlatformId";
